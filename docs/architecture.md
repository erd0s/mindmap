...
The desktop process owns one watcher and emits a lightweight change event to all open windows. The project picker and each graph live in separate native windows. <kbd>⌘</kbd><kbd>O</kbd> opens another picker.
